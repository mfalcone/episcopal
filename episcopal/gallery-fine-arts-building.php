...
<html xmlns="http://www.w3.org/1999/xhtml">
                    ...
                    $.supersized({
                        ...
                        slides                  :   [           // Slideshow Images
                                                        ...
                                                        //*arts_center*//
                                                        {
                                                            ...
                                                            title: 'Upper Gallery',
                                                            nam_opp: 'fine-arts-building/r.upper-gallery.html'
                                                        },
                                                        {
...

                                                        {
                                                            ...
                                                            nam_opp: 'fine-arts-building/b.studio-theater.html'
                                                        },

                                                        {
                                                            image : 'images/gallery/arts_center/1680_main-lobby-&-stair.jpg',
                                                            title: 'Grand Lobby & Stair',
                                                            nam_opp: 'fine-arts-building/c.grand-lobby.html'
                                                        },
                                                        {
                                                            image : 'images/gallery/arts_center/1680_main-gallery-&-concessions.jpg',
                                                            title: 'Main Gallery',
                                                            nam_opp: 'fine-arts-building/g.main-gallery.html'
                                                        },
                                                        {
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            nam_opp: 'fine-arts-building/e.dance-&-choral-hall.html'
                                                        }
                                                    ]
                    });
                });
    ...
    <div id="controls-wrapper" class="load-item">
        <div id="controls">
            <!--Slide counter-->
            <a href="#" rel="" class="borderM solid bgMD colorM btnGreenHill">Naming Opportunities <i class="fa fa-plus"></i></a>
            <!--div id="slidecounter">
